...
class GestionnaireReservationController extends GestionnaireController
{
    ...
    {
        $perimetres = $this->getGPAUser()->getSourceAgent()->getSourceOrgaAffectectation()->getPerimetres();
    ...
    protected function sendBonRemisageAction(Request $request, Application $app, $id)
    {
        ...
        $message->setSubject('GPA - Bon de remisage à domicile')
                ...
                ->setTo(array($this->getGPAUser()->getSourceAgent()->getCtcMessagerie()))
    ...
    {
        $service = $this->getGPAUser()->getSourceAgent()->getSourceOrgaAffectectation();
