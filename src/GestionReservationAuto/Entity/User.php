...
class User extends \DTC\Common\Entity\Master\AbstractEntity
{
    ...
    /**
     * @ORM\Column(name="USE_CODE_SUPERIEUR", type="string")
     */
    private $codeSuperieur;

    /**
     * Alias of SourceAgent.ageHierarchique
     * @return string
     */
    function getCodeSuperieur()
    {
        return $this->sourceAgent->getResponsableHierarchique();
    }

    function setCodeSuperieur($codeSuperieur)
    {
        $this->codeSuperieur = $codeSuperieur;
    }
